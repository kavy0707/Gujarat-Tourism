    ...
    return (
        ...
        <div id='Main'>
            ...
            <section className="Section-2">
                ...
                <p>
                    Gujarat is a state in the western part of India famous for its diverse culture,
                ...
                <p>
                    Gujarat is also the land of Lord Krishna. It’s the hometown to India’s famous freedom
                    fighter
                    <span className="highlight"> Mahatma Gandhi</span>. Hospitality, compassion, and endurance are the edifice upon which
                    <span className="highlight"> Gujarat Tourism</span> is built. Gujarat offers its tourists scenic beauty from
                    <span className="highlight-orange"> Great Rann of Kutch</span> to the hills of Satpura. Gujarat is the only place in the entire world to view pure Asiatic lions.
                </p>
            </section>
